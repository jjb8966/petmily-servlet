    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p><span>Details <i class="ion-ios-arrow-forward"></i></span></p>
                <h1 class="mb-0 bread">유기동물 조회 - 상세보기</h1>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                <div class="d-block services text-center">
                    ...
                    <div class="media-body p-4">
                        ...
                        <p>이 동물에게 후원해주세요!</p>
                        <a href="${pageContext.request.contextPath}/abandoned_animal/auth/donate.do?abNumber=${param.abNumber}"
            ...
            <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                <div class="d-block services text-center">
                    ...
                    <div class="media-body p-4">
                        ...
                        <a
                                href="${pageContext.request.contextPath}/abandoned_animal/auth/adopt_temp.do?abNumber=${param.abNumber}"
                                class="btn-custom d-flex align-items-center justify-content-center"><span
            ...
            <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                <div class="d-block services text-center">
                    ...
                    <div class="media-body p-4">
                        ...
                        <p>봉사해주세요.</p>
                        <a
                                href="${pageContext.request.contextPath}/abandoned_animal/volunteer.do?abNumber=${param.abNumber}"
                                class="btn-custom d-flex align-items-center justify-content-center"><span
                                class="fa fa-chevron-right"></span><i class="sr-only">Read
                            more</i></a>
                    </div>
