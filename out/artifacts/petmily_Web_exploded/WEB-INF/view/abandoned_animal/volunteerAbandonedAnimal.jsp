    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p><span>Volunteer <i class="ion-ios-arrow-forward"></i></span></p>
...
<div class="container survey">
    ...
    <form id="submit-form"
          action="${pageContext.request.contextPath}/abandoned_animal/volunteer.do?abNumber=${param.abNumber}"
          method="POST">

        <div class="form-row">
            <div class="col">
                <label id="name-label">유기동물 이름</label>
                <input readonly id="animal_name" type="text" value=${animalName } class="form-control">
            </div>
        </div>
        <%--주석없애면 삭제--%>
        <!-- <div class="col">
...
-->
        ...
        <div class="form-group">
            <label id="member-name">이름</label>
            <input readonly id="name" type="text" value=${memberName } class="form-control" aria-describedby="emailHelp">
            <small id="form-control1" class="form-text text-muted">※
        ...
        <div class="form-group">
            ...
            <input readonly id="birth" type="text" value=${memberBirth} min="15" max="125" class="form-control" id="text">
            <small id="form-control2" class="form-text text-muted">※ 자원봉사희망자
            정보는 신청자와 관리센터만 볼 수 있습니다.</small>
        </div>

        <div class="form-group">
            <label id="member-phone">연락처</label>
            <input readonly id="phone" type="text" value=${memberPhone} class="form-control" aria-describedby="emailHelp">
            <small id="form-control3" class="form-text text-muted">※ 자원봉사희망자
            정보는 신청자와 관리센터만 볼 수 있습니다.</small>
        </div>

        <div class="form-group">
            <label id="member-email">이메일</label>
            <input readonly id="email" type="text" value=${memberEmail} class="form-control" aria-describedby="emailHelp">
            <small id="emailHelp" class="form-text text-muted">※ 자원봉사희망자 정보는
        ...
        <div class="form-row">
            <div class="col">
                <label>봉사활동 기간</label>
                <input id="volunteerPeriod" type="number" class="form-control" name="period"
                       placeholder="희망하는 봉사 활동 일 수를 기입해 주세요." required="required">
            </div>
            <div class="col">
                <label>봉사 시작날짜</label>
                <input id="volunteerStartDate" type="date" class="form-control"
                    name="startDate" placeholder="입력" required="required">
            </div>
        </div>

        <br/>
        <div class="arr">
            <button id="submit" type="submit" class="btn btn-secondary">신청하기</button>
        </div>
    </form>
    <br/>
</div>
