    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p><span>Donation <i class="ion-ios-arrow-forward"></i></span></p>
...
<div class="container survey">
    ...
    <form name="donaform" id="survey-form" method="post"
          action="${pageContext.request.contextPath}/abandoned_animal/auth/donate.do?abNumber=${param.abNumber}">
        <div class="form-row">
            <div class="col">
                <label>은행명</label>
            ...
            <div class="col">
                ...
                <input name="accountHolder"
                       id="name" type="text" class="form-control" placeholder="예금주"
                       required="required">
            </div>
            <div class="col">
                <label>계좌번호</label>
                <input class="form-control" id="last-name" name="accountNumber"
                       pattern="^(\d{1,})(-(\d{1,})){1,}" placeholder="계좌번호" required="required"
                       type="text"
                       oninput="this.value = this.value.replace(/[^0-9-]/g, '');">
                <label>계좌번호에 '-'를 포함해서 작성 해 주세요</label>
            </div>
        </div>
        <br><br>
        ...
        <div class="form-row">
            ...
            <div class="inline">
                <input id="blank" name="donaSum" onclick="doOpenCheck(this);"
                       type="text" placeholder="직접 입력" required="required"
