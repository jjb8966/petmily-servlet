...
<body>
	...
	<div class="container survey">
		...
		<form id="submit-form"
			action="/abandoned_animal/volunteer.do?abNumber=${param.abNumber}"
			method="POST">
 ...
 -->
			...
			<div class="form-group">
				<label id="member-name">이름</label> <input readonly id="name"
					...
					class="form-text text-muted">※ 자원봉사희망자 정보는 신청자와 관리센터만 볼 수
					있습니다.</small>
			</div>
			...
			<div class="form-group">
				<label id="member-age">생년월일</label> <input readonly id="birth"
					type="text" value=${memberBirth} min="15" max="125" class="form-control" id="text"><small
			...
			<div class="form-group">
				<label id="member-phone">연락처</label> <input readonly id="phone"
					type="text"  value=${memberPhone} class="form-control" aria-describedby="emailHelp"
					> <small
					id="form-control" class="form-text text-muted">※ 자원봉사희망자
					정보는 신청자와 관리센터만 볼 수 있습니다.</small>
			</div>
			...
			<div class="form-group">
				<label id="member-email">이메일</label> <input readonly id="email"
					type="text" value=${memberEmail} class="form-control" aria-describedby="emailHelp"
					> <small
			...
			<div class="arr">
				<button id="submit" type="submit" class="btn btn-secondary"
					style="float: center">신청하기</button>
			</div>
		</form>
