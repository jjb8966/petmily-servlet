			...
			<div class="row d-flex no-gutters">
				<div class="col-md-5 d-flex">
					<div
						...
						style="background-image:url(${detailForm.imgPath});"></div>
				</div>
				...
				<div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
					<div class="d-block services text-center">
						...
						<div class="media-body p-4">
							...
							<p>이 동물에게 후원해주세요!</p>
							<a href="/abandoned_animal/donate.do"
				...
				<div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
					<div class="d-block services text-center">
						...
						<div class="media-body p-4">
							...
							<a
								href="/abandoned_animal/auth/adopt_temp.do?abNumber=${param.abNumber}"
								class="btn-custom d-flex align-items-center justify-content-center"><span
								class="fa fa-chevron-right"></span><i class="sr-only">Read
									more</i></a>
						</div>
				...
				<div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
					<div class="d-block services text-center">
						...
						<div class="media-body p-4">
							...
							<p>입양해주세요.</p>
							<a href="/abandoned_animal/adopt.do"
								class="btn-custom d-flex align-items-center justify-content-center"><span
								class="fa fa-chevron-right"></span><i class="sr-only">Read
									more</i></a>
						</div>
