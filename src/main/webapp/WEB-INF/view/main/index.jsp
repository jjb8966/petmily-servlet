...
<div class="hero-wrap js-fullheight" style="background-image: url('petsitting-master/images/bg_1.jpg');"
        ...
        <div class="row d-flex no-gutters">
            <div class="col-md-5 d-flex">
                <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0"
                     style="background-image:url(petsitting-master/images/about-1.jpg);">
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 order-md-last">
                <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0"
                     style="background-image:url(petsitting-master/images/about-4.jpg);">
                ...
                <div class="d-flex mt-3">
                    <div class="img img-2 mr-md-2"
                         style="background-image:url(petsitting-master/images/about-5.jpg);"></div>
                    <div class="img img-2 ml-md-2"
                         style="background-image:url(petsitting-master/images/about-6.jpg);"></div>
                </div>
            </div>
                        ...
                        <div class="testimony-wrap py-4">
                            ...
                            <div class="text">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img"
                                         style="background-image: url(petsitting-master/images/abani-01.jpg)"></div>
                                    <div class="pl-3">
                    ...
                    <div class="item">
                        <div class="testimony-wrap py-4">
                            ...
                            <div class="text">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img"
                                         style="background-image: url(petsitting-master/images/abani-02.jpg)"></div>
                                    <div class="pl-3">
                    ...
                    <div class="item">
                        <div class="testimony-wrap py-4">
                            ...
                            <div class="text">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img"
                                         style="background-image: url(petsitting-master/images/abani-03.jpg)"></div>
                                    <div class="pl-3">
                    ...
                    <div class="item">
                        <div class="testimony-wrap py-4">
                            ...
                            <div class="text">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img"
                                         style="background-image: url(petsitting-master/images/abani-04.jpg)"></div>
                                    <div class="pl-3">
                    ...
                    <div class="item">
                        <div class="testimony-wrap py-4">
                            ...
                            <div class="text">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img"
                                         style="background-image: url(petsitting-master/images/abani-05.jpg)"></div>
                                    <div class="pl-3">
    ...
    <div class="container">
        ...
        <div class="row d-flex">
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.html" class="block-20 rounded"
                       style="background-image: url('petsitting-master/images/image_1.jpg');">
                    </a>
                    <div class="text p-4">
                        <div class="meta mb-2">
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.html" class="block-20 rounded"
                       style="background-image: url('petsitting-master/images/gallery-12.jpg');">
                    </a>
                    <div class="text p-4">
                        <div class="meta mb-2">
                            <div><a href="#">April 07, 2020</a></div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.html" class="block-20 rounded"
                       style="background-image: url('petsitting-master/images/image_3.jpg');">
                    </a>
                    <div class="text p-4">
                        <div class="meta mb-2">
                            <div><a href="#">April 07, 2020</a></div>
        ...
        <div class="row">
            <div class="col-md-4 ftco-animate">
                <div class="work mb-4 img d-flex align-items-end"
                     style="background-image: url(petsitting-master/images/gallery-8.jpg);">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="work mb-4 img d-flex align-items-end"
                     style="background-image: url(petsitting-master/images/gallery-9.jpg);">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="work mb-4 img d-flex align-items-end"
                     style="background-image: url(petsitting-master/images/gallery-10.jpg);">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="work mb-4 img d-flex align-items-end"
                     style="background-image: url(petsitting-master/images/gallery-11.jpg);">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="work mb-4 img d-flex align-items-end"
                     style="background-image: url(petsitting-master/images/gallery-13.jpg);">
