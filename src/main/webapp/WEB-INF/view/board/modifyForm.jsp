		...
		<div class="row no-gutters slider-text align-items-end">
			<div class="col-md-9 ftco-animate pb-5">
				<p class="breadcrumbs mb-2">
					...
					<span>Veterinarian <i class="ion-ios-arrow-forward"></i>
					</span>
				</p>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<!-- form 시작 -->
					...
					<form class="form" name="enq" method="post" action="/board/modify.do">
						<div class="modal-body">
							<div class="row">
								...
								<div class="form-group">								
									...
									<input type="text" class="form-control" name="title" value="${modReq.title}" required="required" />
								</div>
									<textarea rows="20" name="content" class="form-control" required="required">${modReq.content}</textarea>
