                        ...
                        <div class="modal-footer">
                            ...
                            <c:if test="${authUser.mNumber == readBoardForm.mNumber}">
                                <button type="button" class="btn btn-light"
                                        onclick="location.href='/board/modify.do?kindOfBoard=${param.kindOfBoard}&bNumber=${readBoardForm.bNumber}'">
                                    수정
                                </button>

                                <button type="button" class="btn btn-light"
                                        onclick="if(confirm('정말로 삭제하시겠습니까?'))
                                                {return location.href='/board/delete.do?kindOfBoard=${param.kindOfBoard}&bNumber=${readBoardForm.bNumber}';}">
                                    삭제
                                </button>
                            </c:if>
