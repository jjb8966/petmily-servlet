...
<link rel="stylesheet"
	href="../../../petsitting-master/css/magnific-popup.css">
...
<link rel="stylesheet"
	href="../../../petsitting-master/css/flaticon.css">
...
<div class="row no-gutters">
	<div class="col-md-7">
		<div class="contact-wrap w-100 p-md-5 p-4">
			...
			<form action="/member/change_info.do" method="POST" id="contactForm"
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class="label" for="id">아이디</label> <input type="text"
								class="form-control" name="id" id="id" value="${memberInfo.id}*"
								readonly>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label class="label" for="pw">비밀번호</label> <input type="password"
								class="form-control" name="pw" id="pw" placeholder="pw"
								value="${memberInfo.pw}">
						</div>
					</div>
					<div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class="label" for="grade">회원 등급</label> <input type="text"
								class="form-control" name="grade" id="grade"
